<template>
  <div class="orders">
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-input placeholder="请输入搜索内容" v-model="query" clearable @clear="getOrdersList" @keyup.enter="searchClick">
            <template #append>
      ...
      <!-- 列表信息 -->
      <el-table :data="ordersList" border stripe height="69.7vh" highlight-current-row style="width: 100%">
        <el-table-column type="index" label="序号" header-align="center" align="center" />
        <el-table-column prop="order_number" label="订单编号" header-align="center" sortable />
        <el-table-column prop="order_price" label="订单价格" header-align="center" sortable />
        <el-table-column prop="order_pay" label="是否支付" header-align="center" sortable>
        ...
        <el-table-column prop="is_send" label="是否发货" header-align="center" sortable />
        <el-table-column prop="create_time" label="下单时间" header-align="center" sortable>
          <template v-slot:default="scope">
        ...
        <el-table-column label="操作" header-align="center" width="173px">
          <template v-slot:default="handle">
            ...
            <!-- 物流按钮 -->
            <el-button type="success" icon="el-icon-location-information" size="small" @click="logisticsClick(handle.row)"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
    ...
    <!-- 对话框内容 -->
      ...
      >
        <el-form-item label="省市区/县" prop="address1">
          <el-cascader :options="cityData" placeholder="请选择"
            filterable v-model="editForm.address1" :props="{ expandTrigger: 'hover' }" style="width: 100%"></el-cascader>
        </el-form-item>
