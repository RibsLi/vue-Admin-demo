      ...
      >
        ...
        >
          <template v-slot:default="tag">
            ...
            <el-tag type="success" v-else-if="tag.row.cat_level == 1"
              >二级</el-tag
            >
        ...
        <el-table-column label="操作" header-align="center" width="173px">
          <template v-slot:default="handle">
            ...
            <el-button
              ...
              icon="el-icon-delete"
              size="small"
              @click="removeClick(handle.row.cat_id)"
            ></el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    >
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="submitAddCatForm">确认</el-button>
          <el-button type="warning" @click="resetAddCatForm"> 重置 </el-button>
        </span>
      </template>
    </el-dialog>
    <!-- 编辑分类对话框 -->
