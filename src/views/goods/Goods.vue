<template>
  <div class="goods">
        ...
        <el-table-column label="操作" header-align="center" width="173px">
          <template v-slot:default="handle">
            ...
            <el-button
              ...
              icon="el-icon-edit"
              size="small"
              @click="editClick(handle.row.goods_id)"
            ></el-button>
            <!-- 删除按钮 -->
            <el-button
              type="danger"
              icon="el-icon-delete"
              size="small"
              @click="removeClick(handle.row.goods_id)"
            ></el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <!-- 图片预览对话框 -->
    <el-dialog v-model="preVisible" title="预览图片" width="50%">
